 ...
 * @author antonio
 */
public class JCadastrar extends javax.swing.JFrame {

    private final CalculadoraDao dao;
    /**
     * Creates new form NewJFrame
     */
    public JCadastrar(CalculadoraDao dao) {
        this.dao = dao;
        initComponents();
    ...
    private void jButtonCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonCadastrarActionPerformed
       if(!jTextFieldName.getText().isEmpty() && !jTextFieldEmail.getText().isEmpty() 
               && !jPasswordNew.getText().isEmpty() && !jPasswordRetype.getText().isEmpty()){
           NewUser user = new NewUser();
           user.setName(jTextFieldName.getText().toLowerCase());
           user.setEmail(jTextFieldEmail.getText().toLowerCase());   
           if(jPasswordNew.getText().toLowerCase().equals(jPasswordRetype.getText().toLowerCase())){
              user.setPassword(jPasswordNew.getText().toLowerCase());   
                JOptionPane.showMessageDialog(null,this.dao.CadastraUser(user));
           }else{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JCadastrar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
